function exibirMatrizIncidenciaConsole() {
  console.log("Matriz de incidência Gerada:")
  console.table(gerarMatrizDeIncidencia(estados, ligacoes))
}
...
function exibirMatrizIncidenciaTabela() {
  ...
  tabelaMatriz.className = "mx-auto m-2 border border-slate-300 text-[10px] table-fixed"
  ...
  ligacoes.forEach(([a, b], k) => {
    ...
    thAresta.className = "border border-slate-300 bg-slate-100 px-1 py-[2px] font-bold w-8 text-center"
  ...
  matriz.forEach((valoresDaLinha, indiceEstado) => {
    ...
    thSiglaLinha.className = "border border-slate-300 bg-slate-100 p-[6px] font-bold text-left w-8"
